        ...
        children: [
          Center(
            child: Container(
              ...
              child: Image.asset("assets/icons/bteb_icon.png", width: 200, height: 200),
            ),
          ),
          Center(
            child: Container(
              margin:  EdgeInsets.only(top: 120.0),
              child: Text('BTEB e-Learning ', style: GoogleFonts.nanumGothic(color: Color(0XFF01974D), fontSize: 25, fontWeight: FontWeight.bold),),
            ),
          ),
          Container(
