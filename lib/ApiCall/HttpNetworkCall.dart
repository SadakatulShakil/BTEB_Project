...
class NetworkCall {
  final String baseUrl = "http://139.162.62.197";//"https://www.raddaelearning.org/";
  final String loginUrl = "http://139.162.62.197/login/token.php?service=moodle_mobile_app&moodlewsrestformat=json&";//"https://www.raddaelearning.org/login/token.php?service=moodle_mobile_app&moodlewsrestformat=json&";
